...
{ 1, "Speed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Attack/Cast Rate", data = {
	...
	{ label = "Trigger Rate Cap", flag = "triggered", notFlagList = {"focused", "hasOverride", "metaEnergyTriggered"}, { format = "{2:output:TriggerRateCap}", { breakdown = "TriggerRateCap" }, { modName = "CooldownRecovery", modType = "INC", cfg = "skill", }, }, },
	...
	{ label = "Eff. Source Rate", flag = "triggered", notFlagList = {"focused", "globalTrigger", "metaEnergyTriggered"}, { format = "{2:output:EffectiveSourceRate}", { breakdown = "EffectiveSourceRate" } }, },
	{ label = "Skill Trigger Rate", flag = "triggered", notFlagList = {"focused", "metaEnergyTriggered"}, { format = "{2:output:SkillTriggerRate}", { breakdown = "SkillTriggerRate" }, { breakdown = "SimData" }, }, },
	...
	{ label = "Meta: Maximum Energy", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyMax}", { breakdown = "MetaEnergyMax" }, }, },
	{ label = "Meta: Energy per Event", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyPerEvent}", }, },
	{ label = "Meta: Events per Trigger", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyEventsToTrigger}", { breakdown = "MetaEnergyEventsToTrigger" }, }, },
	{ label = "Meta: Trigger Rate", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyTriggerRate}", { breakdown = "MetaEnergyEventsPerSecond" }, { breakdown = "EffectiveSourceRate" }, }, },
...
{ 1, "Ignite", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Ignite", data = {	
	...
	{ label = "Sustained Ignite Chance", haveOutput = "IgniteChanceSteadyState", { format = "{0:output:IgniteChanceSteadyState}%",
