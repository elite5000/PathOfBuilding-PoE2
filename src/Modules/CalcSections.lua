...
{ 1, "Speed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Attack/Cast Rate", data = {
	...
	{ label = "Maximum Energy", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyMax}", { breakdown = "MetaEnergyMax" }, }, },
	{ label = "Energy per Event", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyPerEvent}", }, },
	{ label = "Events per Trigger", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyEventsToTrigger}", { breakdown = "MetaEnergyEventsToTrigger" }, }, },
	{ label = "Trigger Rate", flag = "metaEnergyTriggered", { format = "{2:output:MetaEnergyTriggerRate}", { breakdown = "MetaEnergyEventsPerSecond" }, { breakdown = "EffectiveSourceRate" }, }, },
